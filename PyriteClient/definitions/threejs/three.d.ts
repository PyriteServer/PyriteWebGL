...
declare module THREE {
   ...
   // custom blending src factors
    ...
    export class OBJMTLLoader {
        ...
        load(url: string, mtlurl: string, onLoad?: (responseText: string) => void, onProgress?: (event: any) => void, onError?: (event: any) => void): void;
    }
    ...
    export class SkinnedMesh extends Mesh {
        //constructor(geometry?: Geometry|BufferedGeometry, material?: MeshBasicMaterial, useVertexTexture?: boolean);
